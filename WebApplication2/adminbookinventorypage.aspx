<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminbookinventorypage.aspx.cs" Inherits="WebApplication2.adminbookinventorypage" %>
         ...
         <div class="col-md-7">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:eLibraryDBConnectionString %>" SelectCommand="SELECT [book_id], [book_name], [gener], [author_name], [publisher_name], [publish_date], [edition], [language], [no_of_pages], [book_description], [actual_stock], [current_stock], [book_img_link], [book_cost] FROM [book_master_tbl]"></asp:SqlDataSource>
                     <div class="col">
