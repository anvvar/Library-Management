<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminmembermanagement.aspx.cs" Inherits="WebApplication2.adminmembermangement" %>
    ...
    <div class="container-fluid">
      <div class="row">
         <div class="col-md-5">
            ...
            <a href="homepage.aspx"><< Back to Home<asp:Button ID="Button2" class="btn btn-lg btn-block btn-danger" runat="server" Text="Delete User Permanently" OnClick="Button2_Click" />
                     </a><br>
            <br>
         </div>
         <div class="col-md-7">
